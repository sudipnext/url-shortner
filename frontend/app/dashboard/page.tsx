...
interface DataProps {
  ...
  total_active_urls: number;
}

export default function DashboardPage() {
  const { data, error } = useSWR<DataProps>(
    `clicks/total_aggregation_by_user/`,
    fetcher
  );
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{data?.no_cities}</div>
                    <p className="text-xs text-muted-foreground">
                      +19% from last month
                    </p>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{data?.total_active_urls}</div>
                    <p className="text-xs text-muted-foreground">
                      +2.1% from last month
                    </p>
                  </CardContent>
